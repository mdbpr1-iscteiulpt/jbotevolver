...
import simulation.physicalobjects.MovableObject3D;
 ...
 * @author alc
 */
public class Robot3D extends MovableObject3D {
	 ...
	 * @param color
	 */
	public Robot3D(Simulator simulator, Arguments args) {
	...
	public static ArrayList<Robot3D> getRobots(Simulator simulator, Arguments arguments) {
		...
		ArrayList<Robot3D> robots = new ArrayList<Robot3D>(numberOfRobots);
		for (int i = 0; i < numberOfRobots; i++)
			robots.add(getRobot(simulator, arguments));
		return robots;
	}

	public static Robot3D getRobot(Simulator simulator, Arguments arguments) {
		Robot3D robot = createRobot(simulator, arguments);
	...
	private static Robot3D createRobot(Simulator simulator, Arguments arguments) {

		if (!arguments.getArgumentIsDefined("classname"))
			throw new RuntimeException("Robot 'classname' not defined: " + arguments.toString());

		return (Robot3D) Factory.getInstance(arguments.getArgumentAsString("classname"), simulator, arguments);
	}

	private static void addSensors(Simulator simulator, Robot3D robot, Arguments arguments) {
	...
	private static void addActuators(Simulator simulator, Robot3D robot, Arguments arguments) {
