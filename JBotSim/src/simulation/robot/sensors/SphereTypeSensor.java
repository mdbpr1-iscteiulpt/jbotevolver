...
public abstract class SphereTypeSensor extends Sensor {
	...
	protected Vector3d 			   sensorPosition 	= new Vector3d();
	...
	public SphereTypeSensor(Simulator simulator, int id, Robot robot, Arguments args) {
