...
public class TwoPreyOrganizeEnvironment extends Environment {
	...
	@ArgumentsAnnotation(name="nestGooddistance", defaultValue="2.0")
	protected double nestGoodDistance;
	@ArgumentsAnnotation(name="nestBaddistance", defaultValue="2.0")
	protected double nestBadDistance;
	...
	public TwoPreyOrganizeEnvironment(Simulator simulator, Arguments arguments) {
		super(simulator, arguments);

		nestGoodDistance = arguments.getArgumentIsDefined("nestGoodDistance") ? arguments.getArgumentAsDouble("nestGoodDistance") : 2;
	...
	public void setup(Simulator simulator) {
		...
		nestA = new Nest(simulator, "NestA", -nestGoodDistance / 2, 0, nestLimit);
		nestA.setParameter("TEAM", 1);
		nestB = new Nest(simulator, "NestB", nestBadDistance / 2, 0, nestLimit);
